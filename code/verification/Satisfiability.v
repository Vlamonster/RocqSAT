...
Proof.
  intros. split.
  - intros [m [Hwf [Htrans Hfinal]]]. exists m. unfold Model. destruct (f_eval m f) eqn:Heq.
    + destruct b.
      * reflexivity.
      * exfalso. apply Hfinal. apply f_eval_false_iff in Heq as [c [Hc_in_f Hconflict]].
    ...
    (* t_decide *)
    + exfalso. apply Hfinal. apply undef_decision_exists in Heq as [l_decide Hfind_dec].
